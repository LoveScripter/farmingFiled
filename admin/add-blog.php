...
if (count($_POST)>0) {
    ...
    if (empty($_POST['blog_name'])) {
        ...
        $errors['blog_text'] = "Please fill the Blog name";
        $is_error = true;
    ...
    if ($is_error==false) {
        ...
        $sql = "INSERT INTO blog (blog_name,blog_text,blog_image) values('$name', '$descp','$final_image')";
        ...
        if ($db_response) {
            ...
            header("Location:list-blog.php?success=Record Created Successfully");
                        ...
                        <form action="add-blog.php" method="POST" enctype="multipart/form-data">
                            <div class="table">
                                <div class="tr">
                                    ...
                                    <div class="cell"><input type="text" name="blog_name" value="<?php echo (isset($_POST['blog_name']))?$_POST['blog_name']:''; ?>" /> </div>
                                </div>
                                <div class="tr">
                                    <div class="cell"><strong>Description:</strong> </div>
                                    <div class="cell"><textarea class="rich-editor" name="blog_text"><?php echo (isset($_POST['blog_text']))?$_POST['blog_text']:''; ?></textarea></div>
                                </div>
                                <div class="tr">
